...
const wpFolder = false; //'../BACK/themes/Gidro';
const paths = {
...
const watchFiles = () => {
  ...
  watch(paths.srcJson, scriptsJson);
...
exports.default = series(clean, htmlInclude, scripts, scriptsSections, scriptsJson, scriptsPlugins, styles, stylesPlugins, stylesSections, fonts, images, webpImages, svgSprites, watchFiles);
...
exports.simple = series(scripts, scriptsSections, scriptsJson, scriptsPlugins, styles, stylesPlugins, stylesSections, watchFilesSimple); //without server, html, images, fonts, svgs.
